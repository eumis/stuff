...
vim.keymap.set('t', '<C-q>', function()
    vim.cmd("q")
    require("usr.statusline").update_git()
end)
...
vim.keymap.set("n", "<space>gm", "<cmd>DiffviewOpen main<cr>", silent_opts)
vim.keymap.set("n", "<space>gd", "<cmd>DiffviewOpen<cr>", silent_opts)
